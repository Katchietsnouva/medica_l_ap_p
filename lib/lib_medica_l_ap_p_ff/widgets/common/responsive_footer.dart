            ...
            return Center(
              child: ConstrainedBox(
                constraints: const BoxConstraints(
                  maxWidth: 1000, // Reduced maxWidth for better centering
                ),
                child: Row(
                  mainAxisAlignment:
                      MainAxisAlignment.end, // Center the columns
                  children: [
                    Flexible(
                      flex: 1,
                    ...
                    const SizedBox(
                        width: 48), // Increased spacing between columns
                    Flexible(
                      flex: 1,
                      child: _buildVisitSection(context),
                    ),
                  ],
                ),
              ),
