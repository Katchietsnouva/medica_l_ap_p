                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 24),
                        SummaryCard(onProceedToPayment: () {
                          provider.showPaymentForm(_scrollToPaymentForm);
                        }),
                        const SizedBox(height: 24),
                        _buildAnimatedSection(
      ...
      children: [
        ...
        ElevatedButton(
          onPressed: () {
            ...
            if (provider.myDob != null &&
                (provider.selectedCoverType == CoverType.me ||
                    (provider.selectedCoverType == CoverType.spouse &&
                        provider.spouseDob != null) ||
                    (provider.selectedCoverType == CoverType.family &&
                        provider.spouseDob != null &&
                        provider.childCount > 0))) {
              provider.showCoverAmountSection(_scrollToCoverAmountSection);
            } else {
              // Optional: Show a message to the user to complete required fields
          ...
          child: const Text('Advance to Cover Amount'),
        ),
      ],
    );
  }
...
//                                 provider.selectCoverType(CoverType.me);
//                                 provider.showDetailsSection(
//                                     _scrollToDetailsSection); // Trigger scroll
//                               },
//                               // =>
//                               //     provider.selectCoverType(CoverType.me),
//                             ),
...
//   Widget _buildDetailsSection(BuildContext context, AppProvider provider) {
//     return Column(
//       key: _detailsSectionKey, // Add key here
//       crossAxisAlignment: CrossAxisAlignment.start,
//       children: [
//         const Divider(height: 40),
//         Text("Personal Details",
...
//   Widget _buildCoverAmountSection(BuildContext context, AppProvider provider) {
//     return Column(
//       key: _coverAmountSectionKey, // Add key here
//       crossAxisAlignment: CrossAxisAlignment.start,
//       children: [
//         const Divider(height: 40),
//         Text("Select Cover Amount",
